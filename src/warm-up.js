...
//Welcome to Braedons B'cause restaurant where we try our best to only serve food that starts with B and ice cream because ice cream
...
inStock -= 1;
//console.log(inStock); //should be 19
...
//inStock = 19;
//var shouldOrderMore = (!!(inStock<20) ); //was having fun playing around with single line conditional assignments before doing it the way im assuming we are supposed to with an if
//console.log(shouldOrderMore);

//sets false then assigns true to prevent the need of an else.
...
if(isFavorite){
   ...
   console.log("I recently at " + food + "!");
}
...
var vegetables = ["beans", "beets", "broccoli", "broad beans","brussel sprouts"];

// Write the code to access the 3rd element of the Array, using bracket
// notation.
console.log("Would you like to order some " + vegetables[2] + "?");

// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.
var fruit = ["banana", "blackberries", "black currant", "blue berries", "bread fruit","bacuri fruit", "Barbados cherry fruit" ];

// Write the code to access the 5th element of the array, using bracket notation.
console.log("Maybe instead you would like to try the " + fruit[4]+ "?" );
...
// Below is a large json object that I have already parsed and set up for you to work on.
// This object should be very familiar to you all. 

// Your goal is to take a deep dive into this data structure and output the total "budget"
// for all the "authors" associated with a "product" inside the "items" array.
